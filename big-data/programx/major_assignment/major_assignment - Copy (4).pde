...
void drawOutput(Table data, Table resourceSummary, Table ageBins, Table ageSummary) {
  ...
  drawBarChart(resourceSummary, overallSummmary, chartWidth, chartHeight);
  popMatrix();
}
 ...
 */
void drawBarChart(Table data, float[][] overallSummmary, float chartWidth, float chartHeight) {
  noFill();
